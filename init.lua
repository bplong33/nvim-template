...
require('lazy').setup({
  ...
  { 'folke/which-key.nvim', opts = {} },
  {
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        keymap('n', '<leader>gp', require('gitsigns').prev_hunk, { buffer = bufnr, desc = '[G]o to [P]revious Hunk' })
        keymap('n', '<leader>gn', require('gitsigns').next_hunk, { buffer = bufnr, desc = '[G]o to [N]ext Hunk' })
  ...
  {
    'akinsho/toggleterm.nvim', version = 'v2.*', opts = {
      size = 20,
      open_mapping = [[<c-\>]],
      hide_numbers = true,
      shade_filetypes = {},
...
keymap('n', '<leader>err', vim.diagnostic.open_float, { desc = 'Open floating diagnostic message' })
